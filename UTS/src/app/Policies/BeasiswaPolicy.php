...
class BeasiswaPolicy
{
    ...
    {
        return $user->can('view_any_beasiswa');
    }
    ...
    {
        return $user->can('create_beasiswa');
    }
    ...
    {
        return $user->can('update_beasiswa');
    }
    ...
    {
        return $user->can('delete_beasiswa');
    }
    ...
    {
        return $user->can('delete_any_beasiswa');
    }
     ...
     */
    public function replicate(User $user, Beasiswa $beasiswa): bool
    {
